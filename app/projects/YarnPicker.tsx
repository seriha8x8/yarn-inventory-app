...
export default function YarnPicker({
  ...
  return (
    <div className="flex flex-col gap-3 text-sm">
              ...
              >
                ...
                <div className="flex items-center gap-2">
                  <input
                    ...
                    className="w-20 rounded-md border border-stone-300 px-2 py-1 dark:border-stone-700 dark:bg-stone-900"
                  />
      ...
      />
      <ul className="flex max-h-48 flex-col gap-1 overflow-y-auto rounded-md border border-stone-200 p-2 dark:border-stone-800">
        {candidates.length === 0 ? (
          ...
          candidates.map((yarn) => (
            <li key={yarn.id}>
              <button
                ...
                className="w-full rounded-md px-2 py-1 text-left hover:bg-stone-100 dark:hover:bg-stone-800"
              >
                {yarn.name}
